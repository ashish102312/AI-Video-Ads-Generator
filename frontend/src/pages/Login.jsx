...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const res = await fetch(`${import.meta.env.VITE_API_URL || 'http://localhost:5001'}/api/v1/auth/login`, {
                method: 'POST',
        ...
        >
            ...
            <div className="relative z-10 w-full max-w-md bg-slate-900/60 p-8 sm:p-10 rounded-2xl shadow-xl shadow-black/50 border border-slate-700/50 backdrop-blur-md transition-all duration-300 hover:border-amber-500/30">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-300">Log in to continue to your dashboard</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <label className="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" className="w-4 h-4 rounded border-slate-700 bg-slate-900/50 text-amber-500 focus:ring-amber-500 focus:ring-offset-slate-900" />
